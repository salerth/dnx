...
namespace Micrsoft.Framework.Runtime.JsonDeserializer
{
    internal class AtlasWeb
    {
        ...
        internal static string JSON_DepthLimitExceeded
        {
            get
            {
                return "RecursionLimit exceeded.";
            }
        }
        ...
        internal static string JSON_ExpectedOpenBrace
        {
            get
            {
                return "Invalid object passed in, '{' expected.";
            }
        }
        ...
        internal static string JSON_InvalidArrayEnd
        {
            get
            {
                return "Invalid array passed in, ']' expected.";
            }
        }
        ...
        internal static string JSON_InvalidArrayExtraComma
        {
            get
            {
                return "Invalid array passed in, extra trailing ','.";
            }
        }
        ...
        internal static string JSON_InvalidMemberName
        {
            get
            {
                return "Invalid object passed in, member name expected.";
            }
        }
        ...
        internal static string JSON_InvalidObject
        {
            get
            {
                return "Invalid object passed in, ':' or '}' expected.";
            }
        }
        ...
        internal static string JSON_InvalidRecursionLimit
        {
            get
            {
                return "RecursionLimit must be a positive integer.";
            }
        }
        ...
        internal static string JSON_MaxJsonLengthExceeded
        {
            get
            {
                return "Error during serialization or deserialization using the JSON JavaScriptSerializer. The length of the string exceeds the value set on the maxJsonLength property.";
            }
        }
        ...
        internal static string JSON_StringNotQuoted
        {
            get
            {
                return "Invalid string passed in, '\\\"' expected.";
            }
        }
        ...
        internal static string JSON_UnterminatedString
        {
            get
            {
                return "Unterminated string passed in.";
            }
        }
    }
}
